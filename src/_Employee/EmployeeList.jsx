  ...
  export default function EmployeeList() {
    ...
    const filteredMunicipalities = provinces
    ? Object.keys(regionsData).reduce((acc, regionCode) => {
      const regions = regionsData[regionCode];
    ...
    ? Object.keys(regionsData).reduce((acc, regionCode) => {
      const regions = regionsData[regionCode];
      console.log(regions.municipality_list)
      if (regions.municipality_list === municipality) {
        return [...acc, ...Object.keys(regions.barangay_list)];
      }
      return acc;
    }, [])
    : [];
